...
characters. Using txtF/0059_cipher.txt (right click and 'Save Link/Target As...'), 
...
with open("txtF/0059_cipher.txt") as f:
...
for i in range(97,123):
    for j in range(97,123):
        for k in range(97,123):
            iter = [c ^ i ^ j ^ k for c in data]
    
            if "the" in "".join(chr(c) for c in iter):
                print(i)
